...
import edu.wpi.first.wpilibj.RobotController; // NEW
...
import java.util.concurrent.ThreadLocalRandom; // NEW
...
public class Robot extends TimedRobot {
  ...
  // NEW: user button edge detection
  ...
  public void robotPeriodic() {
    ...
    // ===========================
    // USER BUTTON → random RGB + relay toggle (NEW)
    // ===========================
    boolean userButton = RobotController.getUserButton(); // true when pressed
    if (userButton && !prevUserButton) { // rising edge
      ...
      // Update dashboard so existing CAN-sender block transmits immediately
