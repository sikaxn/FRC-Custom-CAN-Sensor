...
void setup() {
  ...
  STATUS_ID        = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, STATUS_API_ID, DEVICE_NUMBER);
  COLOR_SENSOR_ID  = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, COLOR_SENSOR_API_ID, DEVICE_NUMBER);
  CONTROL_ID       = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, CONTROL_API_ID, DEVICE_NUMBER);
  DT7_FRAME1_ID    = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, DT7_API1_ID, DEVICE_NUMBER);
  DT7_FRAME2_ID    = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, DT7_API2_ID, DEVICE_NUMBER);
  DT7_FRAME3_ID    = makeCANMsgID(DEVICE_TYPE_ID, MANUFACTURER_ID, DT7_API3_ID, DEVICE_NUMBER);
