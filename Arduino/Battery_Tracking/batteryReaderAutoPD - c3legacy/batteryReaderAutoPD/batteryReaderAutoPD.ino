...
// === RFID Setup ===
MFRC522DriverPinSimple ss_pin1(0);  // Reader 1 SS
MFRC522DriverPinSimple ss_pin2(1);  // Reader 2 SS
...
xTaskCreatePinnedToCore(TaskAutoBatteryManager, "Battery Manager", 4096, NULL, 1, NULL, 0);
...
xTaskCreatePinnedToCore(TaskEnergyCalc,         "Energy Calc",     4096, NULL, 1, NULL, 0);
}
